...
document.addEventListener('DOMContentLoaded', function () {
	...
	chrome.tabs.insertCSS(null, { file: "/src/css/style_facebook.css" });
	...
	document.getElementById("go").addEventListener("click",
		function () {
			window.close();
			browser.tabs.executeScript(null, {file : "/src/general_facebook.js"});
			browser.tabs.executeScript(null, {file : "/src/couche_facebook.js"});
