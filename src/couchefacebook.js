...
var maxDivNumber = 7,
    ...
    mandatoryDivs = {
        ...
        'div.home_right_column': ['sponsorise', 'sponsorise', 'sponsorise_innerdiv', 'sponsorise_innerdivs', chrome.extension.getURL('src/css/cursor.cur'), chrome.extension.getURL('src/facebookfonds/sponsorise.png'), customDivContent.sponsoredside],
        //EXPRIMEZ VOUS
        'div._3u16': ['sponsorise3', 'sponsorise3', 'sponsorise_innerdiv3', 'sponsorise_innerdivs3', chrome.extension.getURL('src/css/cursor.cur'), chrome.extension.getURL('src/facebookfonds/sponsorise.png'), customDivContent.expressyourself],
        // AUTHOR
        'div._5x46': ['sponsorise8', 'sponsorise8', 'sponsorise_innerdiv8', 'sponsorise_innerdivs8', chrome.extension.getURL('src/css/cursor.cur'), chrome.extension.getURL('src/facebookfonds/author.png'), customDivContent.author]

    },
    notMandatoryDivs = {
        // POST DATE
        'div.fsm.fwn.fcg': ['sponsorise0', 'sponsorise0', 'sponsorise_innerdiv0', 'sponsorise_innerdivs0', chrome.extension.getURL('src/css/cursor.cur'), chrome.extension.getURL('src/facebookfonds/comment.png'), customDivContent.postdate],

        // EMOJI REACTION
        'div._3t53._4ar-._ipn': ['sponsorise5', 'sponsorise5', 'sponsorise_innerdiv5', 'sponsorise_innerdivs5', chrome.extension.getURL('src/css/cursor.cur'), chrome.extension.getURL('src/facebookfonds/emojireaction.png'), customDivContent.emojireaction],

        // VIEWS
        'div.clearfix._3-8n': ['sponsorise6', 'sponsorise6', 'sponsorise_innerdiv6', 'sponsorise_innerdivs6', chrome.extension.getURL('src/css/cursor.cur'), chrome.extension.getURL('src/facebookfonds/views.png'), customDivContent.views],

        //  SHARES
        'div.UFIRow.UFIShareRow': ['sponsorise12', 'sponsorise12', 'sponsorise_innerdiv12', 'sponsorise_innerdivs12', chrome.extension.getURL('src/css/cursor.cur'), chrome.extension.getURL('src/facebookfonds/views.png'), customDivContent.shares],

        // ENGAGEMENT WITH POST
        'div._3399._a7s.clearfix._zw3': ['sponsorise9', 'sponsorise9', 'sponsorise_innerdiv9', 'sponsorise_innerdivs9', chrome.extension.getURL('src/css/cursor.cur'), chrome.extension.getURL('src/facebookfonds/views.png'), customDivContent.engagement],

        // COMMENT
        'div.UFIImageBlockContent._42ef': ['sponsorise7', 'sponsorise7', 'sponsorise_innerdiv7', 'sponsorise_innerdivs7', chrome.extension.getURL('src/css/cursor.cur'), chrome.extension.getURL('src/facebookfonds/engagement.png'), customDivContent.comment],

        //SUGGESTED POSTS
        'div._1dwg._1w_m:has( > ._5g-l)': ['sponsorise10', 'sponsorise10', 'sponsorise_innerdiv10', 'sponsorise_innerdivs10', chrome.extension.getURL('src/css/cursor.cur'), chrome.extension.getURL('src/facebookfonds/pushed.png'), customDivContent.suggested],

        //  SPONSORED FEED MESSAGE
        sponsoredMessage: ['sponsorise3', 'sponsorise3', 'sponsorise_innerdiv3', 'sponsorise_innerdivs3', chrome.extension.getURL('src/css/cursor.cur'), chrome.extension.getURL('src/facebookfonds/sponsorisefeed.png'), customDivContent.sponsoredmessage]
