...
var maxDivNumber = 7,
    ...
    notMandatoryDivs = {
        ...
        'div#botstuff': ['googleassociatedsearch', 'googleassociatedsearch', 'googleassociatedsearch_innerdiv', 'googleassociatedsearch_innerdivs', chrome.extension.getURL('src/css/cursor.cur'), chrome.extension.getURL('src/google/brushes/connectedresearch.png'), customDivContent.googleassociatedsearch],
...
(function($) {
    ...
    if ($('#search').length === 0) {
        ...
        if ($('div#slim_appbar').length > 0) {
            mandatoryDivs['div#slim_appbar'] = ['searchresults_amount', 'searchresults_amount', 'searchresults_amount_innerdiv', 'searchresults_amount_innerdivs', chrome.extension.getURL('src/css/cursor.cur'), chrome.extension.getURL('src/google/brushes/resultsnumber.png'), customDivContent.searchresults_amount];
        } else {
            mandatoryDivNumber--;
        }
