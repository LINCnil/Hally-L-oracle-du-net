...
//--------------------------------------------//
    ...
    function legende(div){
        ...
        legende.style.right = "1%";
        legende.style.height = "40%";
        legende.style.width = "20%";
        ...
        image.src = chrome.extension.getURL("src/css/waves1.png");
        ...
        //element.parentNode.insertBefore(legende, element.nextSibling);
